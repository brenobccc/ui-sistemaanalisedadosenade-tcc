...
export default function GraficoIndices(props) {
    ...
    useEffect(() => {
        ...
        const url = `https://api-enade-analisedados-production.up.railway.app/analiseenade/consulta-dados-por-ano-municipio-area-nomeies2?anoInicial=${anoInicial}&anoFinal=${anoFinal}&municipio1=${municipioIes1}&municipio2=${municipioIes2}&area=${area}&nomeies1=${nomeIes1}&nomeies2=${nomeIes2}`;
        axios.get(url)
            .then(response => {
                console.log("dado: ");
